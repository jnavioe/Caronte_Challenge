...
SUBMISSION_FILE = "./public/trameses.csv"
ACTIVITY_FILE = "./public/activitats.csv"
EXAM_FILE = "./public/notes.csv"
...
class ProcessStudents:
    ...
    def _read_csv(file_path):
        try:
            delimiter = ProcessStudents.default_csv_delimiter(file_path)
...
if __name__ == "__main__":
    students = ProcessStudents().process()
