...
def prueba(numero, column1, column2):
     students = []
    ...
    # Cargar los archivos CSV
     ...
     #activitats prova
        ...
        x = activitats.iloc( 0, column1).values.reshape(-1, 1)
        y = activitats.iloc(0, column2).values.reshape(-1, 1)
    ...
    # Mostrar gráfico
        ...
        cols = [activitats.iloc( 0, column1), activitats.iloc( 0, column2)]
        print("jelou")
        activitats.hist()
        plt.show()
     ...
     #examens prova
        ...
        #examens['F_Grade'] = examens['F_Grade'].astype(float)
        #examens['R_Grade'] = examens['R_Grade'].astype(float)
        x = examens['P_Grade'].values.reshape(-1, 1)
